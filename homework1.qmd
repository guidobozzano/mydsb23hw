...
#For the second question I also use the planes table and group them by manufacturer. Then, I create a new variable called total_manuf that counts the amount of manufacturers there are in the table and arrangem them in descending order. Last, I select the top 5 total manufacturers 
planes %>% 
...
# Filter the "flights" table to include data for NYC in 2013
...
ggplot(manufacturers_over_time, aes(x = month, y = count, fill = manufacturer)) +
...
#proportion_rule_applies <- mean(age_gaps$actor_1_age >= (age_gaps$actor_2_age / 2 + 7))

#proportion_rule_applies
